...
def main() -> None:
    ...
    if os.environ.get("NGRAM_ONLY", "0") == "1":
        ...
        ng_alpha_max = float(os.environ.get("NGRAM_ALPHA_MAX", "0.95"))
        ng_alpha_min = float(os.environ.get("NGRAM_ALPHA_MIN", "0.05"))
        ...
        ng_buckets = int(os.environ.get("NGRAM_BUCKETS", "4096"))
        ng_min_count = int(os.environ.get("NGRAM_MIN_COUNT", "1"))
        ng_alpha_clip = float(os.environ.get("NGRAM_ALPHA_CLIP", "0.95"))
