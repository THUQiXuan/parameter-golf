...
def main() -> None:
    ...
    if os.environ.get("NGRAM_ONLY", "0") == "1":
        ...
        ng_alpha_max = float(os.environ.get("NGRAM_ALPHA_MAX", "0.9999"))
        ng_alpha_min = float(os.environ.get("NGRAM_ALPHA_MIN", "0.9999"))
        ...
        ng_alpha_clip = float(os.environ.get("NGRAM_ALPHA_CLIP", "0.9999"))
